...
function pkcs1pad2(n, t) {
    ...
    for (var e = new Array, r = n.length - 1; r >= 0 && t > 0;) e[--t] = n.charCodeAt(r--);
    e[--t] = 0;
    for (var l = new SecureRandom, i = new Array; t > 2;) {
        for (i[0] = 0; 0 == i[0];) l.nextBytes(i);
        e[--t] = i[0]
    }
...
("BDCSBrowserAPI", this, function() {
    "use strict";
    var e = function(t) {
        if (!(this instanceof e)) return new e(t);
        var i = {
            swfContainerId: "BDCSBrowserAPI",
